...
Azure App Service supports two main record types for custom domains: citeturn2search1turn2search2
...
Some DNS providers don’t allow CNAME at the apex (`contoso.com`). The typical pattern is: citeturn2search1turn2search7
...
- **App Service Environment (ASE)** and **Private Endpoints** allow you to expose the app on a **private IP** inside a virtual network instead of the internet. citeturn2search0turn2search1turn2search2
...
4. **Custom domain features require higher tiers**
   - Custom domains and TLS/SSL generally require at least **Basic** tier App Service plan. citeturn1search1turn1search25
